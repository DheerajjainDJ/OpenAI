...
const Community = () => {
  ...
  return (
    <section className="max-w-6xl mx-auto p-8">
      <h1 className="font-extrabold text-center text-black text-3xl dark:text-white">
      ...
      <div className="mt-7 max-w-3xl mx-auto relative flex items-center text-gray-400 focus-within:text-gray-600">
        ...
        <input
          ...
          className="pr-4 pl-9 py-3 w-full rounded-md border-none ring-2 ring-gray-300 focus:border-blue-700 focus:border-2 focus:shadow-md text-black text-lg font-medium placeholder-gray-500"
        />
        {searchText && (
          <CloseIcon
